...
#[post("/login")]
pub async fn login(pool: Data<DbPool>, param: Json<LoginParam>) -> Result<HttpResponse> {
...
#[post("/logout")]
pub async fn logout(pool: Data<DbPool>, param: Json<LogoutParam>) -> Result<HttpResponse> {
